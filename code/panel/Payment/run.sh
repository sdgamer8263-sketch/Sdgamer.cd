...
show_header() {
    clear
    printf "${CYAN}${TOP}\n"
    printf "║${WHITE}                  🚀 SDGAMER PAYMENTER PANEL                 ${CYAN}║\n"
    printf "╠════════════════════════════════════════════════════════════╣\n"
...
install_paymenter() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/Sdgamer8263-sketch/sdgamer.cd/refs/heads/main/code/panel/Payment/install.sh)
